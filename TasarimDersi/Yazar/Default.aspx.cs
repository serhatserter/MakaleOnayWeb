...
namespace TasarimDersi
{
	public partial class Default : System.Web.UI.Page
	{
		...
		protected void Submit(object sender, EventArgs e)
		{
			...
			queryStr = "SELECT * FROM tasarimdersi.yazarkullanici WHERE KullaniciAdi='" + GirisUsername.Text +"' AND Sifre='" + GirisPassword.Text +"'";
			...
			if (reader.HasRows)
			{
				...
				Response.Redirect("MainYazar.aspx", false);
			}
			else
			{
