...
{
	public partial class DefaultEditor : System.Web.UI.Page
	{
		...
		protected void Submit(object sender, EventArgs e)
		{
			...
			queryStr = "SELECT * FROM tasarimdersi.editorkullanici WHERE KullaniciAdi='" + GirisUsername.Text +"' AND Sifre='" + GirisPassword.Text +"'";
			...
			if (reader.HasRows)
			{
				...
				Response.Redirect("MainEditor.aspx", false);
			}
			else
			{
