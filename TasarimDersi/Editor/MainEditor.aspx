<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainEditor.aspx.cs" Inherits="TasarimDersi.MainEditor" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Editör Anasayfa</title>
		...
		<form id="makale" class="form-inline" runat="server" enctype="multipart/form-data">
			...
			<div style=" background-color:white;">
				...
				<div style = "height:700px;  background-color:white">
					...
					<div id="ince" runat="server" width="43%" >
						<center>
				   <asp:RadioButtonList ID="OnayRadio" runat="server">
					...
					<asp:DropDownList  ID="Hakemler" runat="server" Width="25%" AutoPostBack="true">
					</asp:DropDownList><br />
